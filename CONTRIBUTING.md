...
Go to [the GitHub issue tracker](https://github.com/klenkes74/kp-commons/issues?state=open) and find an open issue which needs additional work or a bugfix (e.g. issues labeled with "help wanted" or "bug").
...
Once you have familiarized with the guidelines, you can go to the [GitHub issue tracker for KP-COMMONS](https://github.com/klenkes74/kp-commons/issues/new) to report the issue.
...
same [LGPL 3.0](https://www.gnu.org/licenses/lgpl-3.0.txt) that is applied to KP-COMMONS itself.
...
[Corporate Contributor License Agreement](https://github.com/klenkes74/kp-commons/blob/master/KES%20Corporate%20Contributor%20License%20Agreement%20(2019-12-31).pdf)
form. Then either:
